...
const (
	...
	SubscribeGas         uint64 = 20000 // Base gas cost for SUBSCRIBE opcode
	UnsubscribeGas       uint64 = 5000  // Base gas cost for UNSUBSCRIBE opcode
	NotifySubscribersGas uint64 = 2000  // Base gas cost for NOTIFYSUBSCRIBERS opcode
	PerSubscriberGas     uint64 = 500   // Additional gas per subscriber notified
